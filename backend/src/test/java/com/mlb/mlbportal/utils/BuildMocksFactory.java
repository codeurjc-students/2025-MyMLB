...
public class BuildMocksFactory {
    ...
    public static List<Team> setUpTeamMocks() {
        ...
        Team team2 = buildTeam(TEST_TEAM2_NAME, TEST_TEAM2_STATS_API_ID, TEST_TEAM2_ABBREVIATION, TEST_TEAM2_WINS, TEST_TEAM2_LOSSES, League.AL, Division.EAST, TEST_TEAM2_LOGO);
