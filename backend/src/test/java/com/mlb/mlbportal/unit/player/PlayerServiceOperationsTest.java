...
class PlayerServiceOperationsTest {
    ...
    void testZeroStatsForEmptyPositionPlayer() {
        PositionPlayer player = new PositionPlayer("EmptyPlayer", 43, this.teams.get(0), PlayerPositions.CF, 0, 0, 0, 0);
        player.setTriples(0);
    ...
    void testZeroStatsForEmptyPitcher() {
        Pitcher pitcher = new Pitcher("EmptyPitcher", 32, this.teams.get(1), PitcherPositions.SP, 0, 0, 0, 0);
        pitcher.setTotalStrikeouts(0);
        pitcher.setWalks(0);
        pitcher.setHitsAllowed(0);
        pitcher.setRunsAllowed(0);
        pitcher.setSaves(0);
        pitcher.setSaveOpportunities(0);
