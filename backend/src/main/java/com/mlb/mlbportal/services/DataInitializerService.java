...
public class DataInitializerService {
    ...
    private void generateDailyMatches(List<Match> matches, List<Team> teams, Set<String> usedPairs,
            LocalDateTime baseDate, int day) {
    ...
    private MatchStatus determineMatchStatus(LocalDateTime matchDate) {
        ...
        if (matchDate.plusHours(3).isBefore(now))
