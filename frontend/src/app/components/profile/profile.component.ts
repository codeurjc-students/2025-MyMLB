...
@Component({
	...
	imports: [CommonModule, FormsModule, RemoveConfirmationModalComponent, ProfileButtons, SuccessModalComponent, ErrorModalComponent, LoadingModalComponent, MatInputModule, MatFormFieldModule],
})
